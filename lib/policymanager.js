...
(function () {
  ...
  var notifications = require('webinos-notifications');
  var notificationManager = notifications.notificationManager;
  var promptTimeout = 20000;
  var promptCallbacks = {};

  // TODO - move these (into PZP core?)
//  var emailHandler = new notifications.EmailHandler();
  var trayHandler = new notifications.TrayHandler();
  var promptHandler = new notifications.PromptHandler();
